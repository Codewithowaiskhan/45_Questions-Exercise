...
let current_users = ["Owais", "madaD", "Admin", "Hamza", "Taha", "Zaid", "Waqar"];

let new_users = ["Ahmed","Manzoor","Madad","hamza","Waqar",];
...
if(userNameTaken){
    console.log(`${new_user} needs to choose a new user name because it's already taken\n`);
}else{
